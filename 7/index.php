...
<?php
$fh = fopen('date.txt', 'r');
$date_string = fread($fh, filesize('date.txt'));
fclose($fh);
?>
...
<script>
    ...
    var newDateString = "<?php echo $date_string; ?>";
    
    var bd = new Date(newDateString);
	...
	reset.addEventListener('click', function(e){
        ...
        .then(authenticated => {
            if(authenticated ==  199 + resetSalt ){
                bd = new Date();
                var fd = new FormData();
                fd.append('date', bd.toString());
